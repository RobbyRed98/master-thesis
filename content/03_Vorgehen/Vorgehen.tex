...
\todo{Version und Lizensierung von Db2 erwähnen}

Bei der Db2 Instanz, die von beiden Db2 Graph Versionen genutzt wird, gilt es dabei zu erwähnen, dass sie so konfiguriert wurde, dass ihr 180 GB an Arbeitsspeicher zur Verfügung stehen. Darüber hinaus verfügt sie über die für Linkbench benötigte Datenbank \texttt{linkdb0}. Diese weist im Kontext aller Messungen das in \autoref{src:linkdb0_schema} beschrieben Datenbankschema auf:
...
\todo{Vereinheitlichen von Graph-Struktur und Graphstruktur.}