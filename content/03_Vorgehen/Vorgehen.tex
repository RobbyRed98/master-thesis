...
Wie in der \nameref{einleitung} aufgeführt, war es in dieser Arbeit vorgesehen, die von \citeAY{sigmod_tian} erzielten Werte für Db2 Graph zu reproduzieren und mit neuen Werten für Neo4j zu vergleichen. 
...
Bezüglich des Datensatzes werden hingegen ein paar Eigenschaften von \citeAY{sigmod_tian} aufgeführt. Wie und ob der dort verwendete Datensatz durch den Daten-Generator von Linkbench erzeugt werden kann, ist jedoch weiterhin unklar.
...
\end{itemize}
Die eingeklammerten Zahlen bei \texttt{getLinkList} repräsentieren hierbei die obere Grenze der Ergebnismenge der Operation. Die Rolle und der Einsatz der Begrenzung der Ergebnismenge wird dabei anschließend in \autoref{analyse:ergebnismenge} im Detail erläutert. 
