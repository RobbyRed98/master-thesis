...
Die ID-Queries spielen dabei im Rahmen der Arbeit lediglich eine untergeordnete Rolle. Sie werden dabei anfänglich als Messparameter in die Performance-Analyse mit einbezogen, da erste Testmessungen darauf hindeuteten, dass sich ihr Einsatz positiv auf die Performance von Db2 Graph Beta 3 auswirkt. Im Verlauf der Performance-Analyse ließ sich dies allerdings nicht bestätigen. Daher werden die ID-Queries lediglich in einer Messreihe bei der Performance-Analyse herangezogen. 
\todo{Bessere ausrede schreiben.}
