...
Für die erzielten Latenzwerte werden neben der durchschnittlichen Latenz (Mean) einer gebenchmarkten Operation auch das 25. (p25), 50. (p50), 75. (p75), 95. (p95) und 99. (p99) Perzentil aufgeführt sowie die höchste gemessene Latenz (Max.). Für den Vergleich der Ergebnisse der Datenbanksysteme wird allerdings hauptsächlich die Durchschnittslatenz (Mean) herangezogen. Bei den Perzentilen wird nicht ein einzelner Wert angegebenen, sondern die Linkbench eigene Darstellung in einem Intervall übernommen. Diese führt dabei die untere und obere von Linkbench errechnete Grenze eines Perzentils auf.
