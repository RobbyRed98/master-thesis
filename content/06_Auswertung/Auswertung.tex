...
Basierend auf \autoref{fig:einbruch:durchsatz:10m} und \autoref{fig:einbruch:durchsatz:100m} das Fazit gezogen werden, dass der Performance-Einbruch beim Umgang mit größeren Ergebnismengen Neo4j nicht nur in absoluten Zahlen ausfällt, sondern auch im Verhältnis, etwas höher ausfällt als bei Db2 Graph. 
