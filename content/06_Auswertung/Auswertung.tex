...
Bevor mit der Beurteilung der in \autoref{tab:sql_benchmark} Werte begonnen werden kann, muss darauf hingewiesen werden, dass die in der Tabelle aufgeführten Zeiten nicht mit den im Rahmen der Performance-Analyse ermittelten Latenzen vergleichbar sind. Schließlich liegen bei Messungen mit dem \texttt{db2batch}-Werkzeug andere Bedingungen als bei dem Einsatz von Linkbench. 
