...
\hyphenation{be-zie-hungs-wei-se}
...
\hyphenation{Ope-ra-ti-on}
\hyphenation{Ope-ra-ti-on-en}
\hyphenation{Er-geb-nis-men-ge}
\hyphenation{in-te-res-san-ter-wei-se}
\hyphenation{Graph-mo-dells}
\hyphenation{Graph-mo-dell}
\hyphenation{Graph-mo-del-le}
\hyphenation{Graph-mo-del-len}
